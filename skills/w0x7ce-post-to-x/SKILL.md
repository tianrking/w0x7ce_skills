---
name: w0x7ce-post-to-x
description: Post content and articles to X (Twitter). Supports regular posts with images/videos and X Articles (long-form Markdown). Uses real Chrome with CDP to bypass anti-automation. Supports Traditional Chinese.
---
...
1. `.w0x7ce-skills/w0x7ce-post-to-x/EXTEND.md` (project)
2. `~/.w0x7ce-skills/w0x7ce-post-to-x/EXTEND.md` (user)
